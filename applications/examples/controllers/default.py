...
def what(): return response.render(dict())
def who(): return response.render(dict())
def download(): return response.render(dict())
def docs(): return response.render(dict())
def support(): return response.render(dict())
...
def authentication(): return response.render(dict())
def authorization(): return response.render(dict())
