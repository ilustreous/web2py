...
class TestBareHelpers(unittest.TestCase):
    def testRun(self):
        ...
        self.assertEqual(INPUT(_a='1',_b='2').xml(),'<input a="1" b="2" />')
        ...
        self.assertEqual(CODE('<>',_a='1',_b='2').xml(),
                         '<table b="2" a="1"><tr valign="top"><td style="width:40px; text-align: right;"><pre style="\n        font-size: 11px;\n        font-family: Bitstream Vera Sans Mono,monospace;\n        background-color: transparent;\n            margin: 0;\n            padding: 5px;\n            border: none;\n        background-color: #E0E0E0;\n        color: #A0A0A0;\n    ">1.</pre></td><td><pre style="\n        font-size: 11px;\n        font-family: Bitstream Vera Sans Mono,monospace;\n        background-color: transparent;\n            margin: 0;\n            padding: 5px;\n            border: none;\n            overflow: auto;\n    "><span style="font-weight: bold">&lt;&gt;</span></pre></td></tr></table>')
        ...
        self.assertEqual(SELECT('<>',_a='1',_b='2').xml(),
                         '<select a="1" b="2"><option value="&lt;&gt;">&lt;&gt;</option></select>')
