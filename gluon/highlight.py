    ...
    all_styles = {
        ...
        'PYTHON': ( python_tokenizer,
            (
                ...
                ('WEB2PY', re.compile( r'(request|response|session|cache|redirect|HTTP|TR|XML|URL|BEAUTIFY|A|BODY|BR|B|CENTER|CODE|DIV|EM|EMBED|FIELDSET|FORM|H1|H2|H3|H4|H5|H6|IFRAME|HEAD|HR|HTML|IMG|INPUT|LABEL|LI|LINK|LO|LU|META|OBJECT|ON|OPTION|P|PRE|SCRIPT|SELECT|SPAN|STYLE|TABLE|TD|TEXTAREA|TH|TITLE|TT|T|IS_ALPHANUMERIC|IS_DATETIME|IS_DATE|IS_EMAIL|IS_EXPR|IS_FLOAT_IN_RANGE|IS_INT_IN_RANGE|IS_IN_SET|IS_LENGTH|IS_MATCH|IS_NOT_EMPTY|IS_TIME|IS_URL|CLEANUP|CRYPT|IS_IN_DB|IS_NOT_IN_DB|SQLDB|SQLField|SQLFORM|SQLTABLE)(?![a-zA-Z0-9_])'), 'link:%(link)s;text-decoration:None;color:#FF5C1F;'),
